...
/**
 * Appointment Event - MUST BE IDENTICAL TO APPOINTMENT SERVICE
 * Used by Booking Service to consume appointment events from RabbitMQ
 */
@Data
@Builder
@NoArgsConstructor
...
public class AppointmentEvent implements Serializable {
    ...
    // Event metadata
    private String eventType; // APPOINTMENT_CREATED, APPOINTMENT_CONFIRMED, etc.
