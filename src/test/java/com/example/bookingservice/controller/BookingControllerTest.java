...
public class BookingControllerTest {
    ...
    @Test
    @WithMockUser(roles = "STUDENT")
    void getBookingById_WithStudentRole_Success() throws Exception {
    ...
    void getAllBookings_WithAdminRole_Success() throws Exception {
    ...
    void getBookingsByRequester_WithAuthenticatedUser_Success() throws Exception {
        List<BookingDto> bookings = Arrays.asList(testBookingDto);
    ...
    void getBookingsByProvider_WithLandlordRole_Success() throws Exception {
        List<BookingDto> bookings = Arrays.asList(testBookingDto);
    ...
    @Test
    @WithMockUser(roles = "LANDLORD")
    void updateBookingStatus_WithLandlordRole_Success() throws Exception {
    ...
    @Test
    @WithMockUser(roles = "STUDENT")
    void cancelBooking_WithAuthenticatedUser_Success() throws Exception {
        ...
        when(bookingService.cancelBooking("booking-123", "test reason"))
        ...
        verify(bookingService).cancelBooking("booking-123", "test reason");
    }

    @Test
    @WithMockUser(roles = "STUDENT")
    void processPayment_WithStudentRole_Success() throws Exception {
        // Arrange
    ...
    @Test
    @WithMockUser(roles = "STUDENT")
    void getPaymentByBookingId_WithAuthenticatedUser_Success() throws Exception {
    ...
    @Test
    @WithMockUser(roles = "USER")
    void confirmBooking_WithValidToken_Success() throws Exception {
        ...
        when(bookingService.confirmBooking("valid-token")).thenReturn(confirmedBooking);

        mockMvc.perform(get("/api/bookings/confirm/valid-token"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
                .andExpect(jsonPath("$.message").value("Booking confirmed successfully"));

        verify(bookingService).confirmBooking("valid-token");
    }

    @Test
    @WithMockUser(roles = "ADMIN")
    void deleteBooking_WithAdminRole_Success() throws Exception {
    ...
    void getBookingsByStatus_WithLandlordRole_Success() throws Exception {
        List<BookingDto> bookings = Arrays.asList(testBookingDto);
